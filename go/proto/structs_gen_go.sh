...
ROOTTYPES="ASEntry CtrlPld PathSegment PathSegmentSignedData RevInfo SCIONDMsg SignedBlob SignedCtrlPld SVCResolutionReply ColibriRequestPayload SignedMSList"
