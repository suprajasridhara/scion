...
func (t *RWTopology) populateServices(raw *jsontopo.Topology) error {
	...
	t.PCN, err = svcMapFromRaw(raw.PCN)
	if err != nil {
		return serrors.WrapStr("unable to extract PCN address", err)
	}
	return nil
}
...
func (t *RWTopology) getSvcInfo(svc proto.ServiceType) (*svcInfo, error) {
	...
	case proto.ServiceType_pcn:
		return &svcInfo{idTopoAddrMap: t.PCN}, nil
	default:
