...
//PGNEngine implements the trust.Provider interface
type PGNEngine struct {
	Msgr infra.Messenger
	IA   addr.IA
}

func (m PGNEngine) NotifyTRC(ctx context.Context, trcId cppki.TRCID,
	o ...trust.Option) error {

	return nil
}

func (m PGNEngine) GetChains(ctx context.Context, cq trust.ChainQuery,
...
func (m PGNEngine) GetSignedTRC(ctx context.Context, trcId cppki.TRCID,
